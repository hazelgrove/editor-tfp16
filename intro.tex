...
Although programs can be represented as text, most text does not correspond to a syntactically well-formed program, much less a semantically well-defined one. Programmers, and the tools that they use, can thus be left to examine and manipulate text for which there are no useful
