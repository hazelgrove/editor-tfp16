...
\begin{array}{|l|l|l|l|}
  \hline
  \textrm{Partial Term} & \textbf{H-Expression} & \textbf{Z-Expression} & \textbf{Action}
  \\
  \hline    
  \_                   & \hhole{} &&
  \\
  (\_)~\_              & \hap{\hhole{}}{\hhole{}} &&
  \\
  (\lambda x.~\_)~\_   & \hap{\hlam{x}{\hhole{}}}{\hhole{}} &&
  \\
  (\lambda x.~x)~\_    & \hap{\hlam{x}{x}}{\hhole{}} &&
  \\
  (\lambda x.~x)~3     & \hap{\hlam{x}{x}}{3} &&
  \\
  (\lambda x.~x + 1)~3 & \hap{\hlam{x}{x + 1}}{3} &&
  \\
  (\lambda x.~x + \_)~3 & \hap{\hlam{x}{x + \hhole{}}}{3} &&
  \\
  (\lambda x.~x + \_)~3 & \hap{\hlam{x}{x + \hhole{}}}{3} &&
  \\
  \hline
