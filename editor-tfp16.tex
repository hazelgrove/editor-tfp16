...
and 
\fbox{$\performSyn{\hGamma}{\zexp}{\htau}{\alpha}{\zexp'}$}
and
...
\inferrule{
  ...
  \performSyn{\hGamma}{\zexp}{\htau}{\aMove{\delta}}{\zexp'}
}
\end{equation}
\begin{equation}
\inferrule{
...
\begin{equation}
  \inferrule{
    ...
    \performSyn{\hGamma}{\zexp}{\htau}{\aDel}{\zexp'}
  }
\end{equation}
\begin{equation}
  \inferrule{
