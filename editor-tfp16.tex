...
This observation has led to the development of various  \emph{structure editors} -- editors where each edit action corresponds to a sensible structural transformation. 
The design space of structure editors is high-dimensional, and existing systems are large and somewhat \emph{ad hoc}. 
