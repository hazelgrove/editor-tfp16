...
%% ways. Most interestingly, instead of giving separate movement rules for
%% each form of Z-expression, we abstract over different corresponding forms
%% that happen to have the same arity, e.g.  additions and
%% applications. Formalizing this intuition reduces the number of cases we
%% need to consider somewhat, but more importantly allows us to write a
%% slightly more general calculus -- it will be easier to extend Hazelnut with
%% more interesting language features with this generic infrastructure in
%% place.
